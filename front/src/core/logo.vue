<template>
	<div class="box-logo flex align-center" :class="{'nav-collapsed':collapseNav, [mode]:true}">
		...
		<img class="image-logo" src="sm-logo.png" alt="logo"/>
		<div class="app-name" @click="goto('/products')" :style="{'font-size': '12px'}"><span><strong>ДОТООД ЗАХИАЛГЫН<br>СИСТЕМ v1.3</strong></span></div>
