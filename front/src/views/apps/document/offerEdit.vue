                            ...
                            <div class="invoice bg-white black-text">		
                                <div class="invoice-top">
                                    ...
                                    <div class="title" align="right">
                                        ...
                                        <p class="address">Монгол улс, Улаанбаатар хот, ЧД 4-р хороо<br>
                                ...
                                <div class="invoice-middle">
                                    ...
                                    <div class="project" align="right">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td align="right" style="width: 60%; padding-right: 10px;"><strong>Нийлүүлэх хугацаа ( хоног ) :</strong></td>
                                                <td style="width: 40%;">
                                                    <el-input-number v-model="invoiceTo.available_date" controls-position="right" :min="0" style="width: 100%;" size="mini"></el-input-number>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" style="width: 60%; padding-right: 10px;"><strong>Урьдчилгаа төлбөр ( хувь ) :</strong></td>
                                                <td style="width: 40%;">
                                                    <el-input-number v-model="invoiceTo.pre_amount" controls-position="right" :min="0" style="width: 100%;" size="mini"></el-input-number>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>   
                                ...
                                <div class="invoice-bottom" v-for="(item, index) in products" :key="index">
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <el-input placeholder="Бүтээгдэхүүн" v-model="item.product_name" @keyup.enter.native="searchProduct(index)" clearable> </el-input>
                                                </td>
                                                <td>
                                                    <el-input-number v-model="item.remain" :min="1"></el-input-number>
                                                </td>
                                                <td :style="{'width': '15%'}">
                                                    <el-input placeholder="Бүтээгдэхүүний тайлбар" v-model="item.price" clearable> </el-input>
                                                </td>
                                                <td :style="{'width': '10%'}">{{Number(item.price * item.remain).toLocaleString()}}</td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <el-input type="textarea" :rows="2" placeholder="Бүтээгдэхүүний тайлбар" v-model="item.description"> </el-input>
                                                </td>
                                                <td></td><td></td><td></td>
                                            </tr>
                                        </tbody>
    ...
    methods: {
        updateInvoice(done) {
			...
			if(token) {
				this.$axios({
					method: 'post',
					url: rts.$appUrl +`/api/offer/update-offer`,
					headers: {
        ...
        addToInvoice(val) {
            ...
            if(ex) {
                ...
                l.product_name = val.model + ' ' + val.name;
                l.product_model = val.model;
                l.price = val.sale_price;
                l.remain = 1;
                l.description = val.description;
        ...
        addProduct() {
            var arr = {product_name: '', product_model: '', remain: 1, price: 0, description: ''};
        ...
        getInvoice() {
			...
			if(token) {
				this.$axios({
					method: 'post',
					url: rts.$appUrl +`/api/offer/get-offer`,
					headers: {
						"Authorization": `Bearer ${token}`
					},
                    data: {
